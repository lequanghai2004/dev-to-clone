...
>(({ className, align, sideOffset = 4, ...props }, ref) => (
    <DropdownMenuPrimitive.Portal>
        <DropdownMenuPrimitive.Content
            ...
            className={cn(
                'z-50 min-w-[8rem] overflow-hidden rounded-md border border-base-900 bg-popover p-1 text-popover-foreground shadow-md',
...
>(({ className, ...props }, ref) => (
    <DropdownMenuPrimitive.Separator ref={ref} className={cn('-mx-1 my-1 h-px bg-base-900', className)} {...props} />
));
